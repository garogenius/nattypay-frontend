        ...
        <div className="w-full max-w-[1440px] h-auto min-h-[222px] lg:h-[222px] relative flex flex-col lg:flex-row items-start justify-start lg:items-center lg:justify-start lg:px-0 lg:py-0 lg:pl-[100px] xl:pl-[150px]">
            ...
            <div className="flex flex-col items-start justify-start gap-6 z-10 w-full">
              ...
              <div className="flex flex-row items-center gap-4">
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <a href="#" className="flex flex-row items-center justify-center w-[140px] h-[44px] bg-[#E5E7EB] hover:bg-gray-300 rounded-[8px] transition-colors gap-2 px-2">
          ...
          <div className="hidden lg:flex flex-row items-center justify-start gap-[150px] xl:gap-[286px] z-10 w-auto">
            ...
            <div className="flex flex-row items-center gap-6">
              ...
              <div className="flex flex-col gap-3">
                {/* Google Play Button */}
                <a href="https://play.google.com/store/apps/details?id=com.nattypay.nattypay" target="_blank" rel="noopener noreferrer" className="flex flex-row items-center justify-center w-[160px] h-[50px] bg-[#E5E7EB] hover:bg-gray-300 rounded-[8px] transition-colors gap-2 px-3">
                ...
                {/* App Store Button */}
                <a href="#" target="_blank" rel="noopener noreferrer" className="flex flex-row items-center justify-center w-[160px] h-[50px] bg-[#E5E7EB] hover:bg-gray-300 rounded-[8px] transition-colors gap-2 px-3">
