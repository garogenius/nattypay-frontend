    ...
    <>
      ...
      <div className="hidden lg:block">
        <section
          ...
          style={{
            background: 'linear-gradient(90deg, rgba(0, 0, 0, 0.94) 43.24%, rgba(102, 102, 102, 0) 100%), url("/img/gbp_hero_bg.png")',
        ...
        >
          <div
            ...
            style={{ paddingLeft: '116px', paddingRight: '96px' }}
          >
            <div className="flex flex-col items-start gap-[58px] max-w-[662px]">

              {/* Inner content — pill, heading, subtitle, buttons, trust */}
              <div className="flex flex-col items-start gap-[42px] w-full">

                {/* Top block: pill + heading + subtitle */}
                <div className="flex flex-col items-start gap-[32px] w-full">
                  ...
                  <div className="flex flex-row items-center gap-[14px] bg-[#4D4D4D] rounded-[16px] px-[12px] py-[9px] w-max">
                    ...
                    <span className="font-poppins font-medium text-[15px] leading-[22px]">
                      <span className="text-[#FFCE65]">GBP</span>{' '}
                      <span className="text-[#CCCCCC]">United Kingdom</span>
                    </span>
                  </div>
                  ...
                  <p className="font-poppins font-normal text-[20px] leading-[35px] text-white m-0 max-w-[517px]">
                    Open your GBP Account with NattyPay and receive internationaly payment, hold s GBP securely convert currency instantly and pay globally- all from one wallet
                  </p>
                </div>
      ...
      <div className="block lg:hidden">
        <section className="relative w-full flex flex-col items-center justify-start min-h-[700px] overflow-hidden bg-[#111]">
          {/* Background */}
          <div className="absolute inset-0 z-0">
            <div
              className="absolute inset-0 bg-cover bg-center"
              style={{ backgroundImage: 'url("/img/gbp_hero_bg.png")' }}
            />
            <div className="absolute inset-0 bg-black/70 bg-gradient-to-t from-black via-black/80 to-black/30" />
          </div>

          <div className="relative z-10 w-full mx-auto flex flex-col items-start justify-center h-full px-[32px] py-[60px]">
            <div className="flex flex-col items-start gap-8 w-full mt-10">
              ...
              <div className="flex flex-col items-start gap-6 w-full">
                ...
                <div className="flex flex-row items-center gap-3 bg-[#4D4D4D] rounded-[16px] px-3 py-2 w-max">
                  <img src="https://flagcdn.com/w80/gb.png" alt="UK Flag" className="w-[24px] h-[24px] rounded-full object-cover" />
              ...
              {/* Trust Badges */}
              <div className="flex flex-row items-center justify-center gap-4 opacity-90 w-full mt-4">
                <div className="flex items-center gap-2">
                  <span className="font-poppins text-[11px] text-[#CCCCCC] whitespace-nowrap">Licenced by CBN</span>
                  <img src="/img/icons/cbn.png" alt="CBN Logo" className="h-[24px] object-contain flex-shrink-0" />
                </div>
                <div className="flex items-center gap-2">
                  <span className="font-poppins text-[11px] text-[#CCCCCC] whitespace-nowrap">Deposits Insured by</span>
