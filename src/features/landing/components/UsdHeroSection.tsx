...
export default function UsdHeroSection() {
  return (
    <>
      {/* DESKTOP VIEW - EXACTLY MATCHING HEADER/NGN HERO STRUCTURE */}
      <div className="hidden lg:block">
        <section 
          className="relative w-full min-w-[1440px] flex items-center h-[755px] overflow-hidden"
          style={{
            background: 'linear-gradient(90deg, rgba(0, 0, 0, 0.94) 43.24%, rgba(102, 102, 102, 0) 100%), url("/img/usd_hero_bg.png")',
        ...
        >
          ...
          >
            {/* Main Content Container matching Figma Frame 1309 width */}
            <div className="flex flex-col items-start gap-[42px] max-w-[662px]">
              ...
              <div className="flex flex-col items-start gap-[32px] w-full">
                ...
                <div className="flex flex-row items-center gap-[14px] bg-[#4D4D4D] rounded-[16px] px-[12px] py-[10px] w-max">
                  <img src="/img/us_flag_icon.png" alt="US Flag" className="w-[29px] h-[29px] rounded-full object-cover" />
                  <span className="font-poppins font-medium text-[15px] leading-[22px]">
                    <span className="text-[#FFCE65]">USD</span> <span className="text-[#CCCCCC]">United State</span>
                  </span>
                </div>

                {/* Main Heading */}
                <h1 className="font-poppins font-semibold text-[64px] leading-[61px] text-white m-0 max-w-[662px]">
                  Receive, Hold & Spend <span className="text-[#FFCE65]">US Dollars</span> Anywhere
                </h1>

                {/* Subtitle */}
                <p className="font-poppins font-normal text-[20px] leading-[35px] text-white m-0 max-w-[517px]">
                  Open your USD Account with NattyPay and receive internationaly payment, hold s Dollar securely convert currency instantly and pay globally- all from one wallet
                </p>
        ...
        <section className="relative w-full bg-[#111] flex items-start pt-16 pb-16 overflow-hidden">
          ...
          <div className="absolute inset-0 z-0">
            <div 
              ...
              style={{ backgroundImage: 'url("/img/usd_hero_bg.png")' }}
            />
            {/* Stronger overlay on mobile since text goes directly over the image */}
            ...
            <div className="w-full flex flex-col items-start pt-6 overflow-hidden gap-6 sm:gap-8">
              ...
              <div className="flex flex-col items-start gap-6 w-full">
                ...
                <div className="flex flex-row items-center gap-3 bg-[#4D4D4D] rounded-[16px] px-3 py-2 w-max">
                  <img src="/img/us_flag_icon.png" alt="US Flag" className="w-[24px] h-[24px] rounded-full object-cover" />
